          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-indigo-100">
              {[
                ...
                { label: 'Variable Spending', key: 'expense' as const, color: 'text-slate-700', neg: true },
                { label: 'Investment', key: 'investment' as const, color: 'text-brand-600', neg: true },
            ...
            <tfoot>
              <tr className="border-t-2 border-indigo-300">
                ...
                {months.map(m => {
                  ...
                  return (
                    <td key={m.month} className={`pt-2 text-right tabular-nums text-xs font-bold ${net >= 0 ? 'text-emerald-700' : 'text-rose-600'}`}>
                ...
                {(() => {
                  ...
                  return (
                    <td className={`pt-2 text-right tabular-nums text-xs font-bold ${total >= 0 ? 'text-emerald-700' : 'text-rose-600'}`}>
